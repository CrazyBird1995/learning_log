...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while index <= num_rolls:
        ...
        if num == 1:
            ...
            sum_a = sum_a + num
        index = index + 1
    return sum_a if not pig_out else 1
    # END PROBLEM 1
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 3
    num_rolls = free_bacon(opponent_score) if num_rolls == 0 else roll_dice(num_rolls,dice= dice)
    return num_rolls
    # END PROBLEM 3
...
def is_swap(score0, score1):
    ...
    if score0 <= 1 or score1 <= 1:
        ...
        if score1 == score0:
            ...
            return False if score0 % score1 > 0 else True
        else:
            return False if score1 % score0 > 0 else True
    # END PROBLEM 4
